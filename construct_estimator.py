...
from .constrained_logit import CMNLEstimator
from .constrained_logit import split_param_vec as cmnl_split_params
...
model_type_to_resources =\
    {"MNL": {'estimator': MNLEstimator, 'split_func': mnl_split_params},
     ...
     "CMNL": {'estimator': CMNLEstimator,
                     'split_func': cmnl_split_params}}
