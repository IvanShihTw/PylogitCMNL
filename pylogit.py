...
@author:    Timothy Brathwaite, Ivan Shih
...
@notes:     "Under the hood", this module indirectly or directly relies upon
            ...
            [base_multinomial_cm_v2.py,
             ...
             constrained_logit.py,
             constrained_logit_endo.py,
             asym_logit.py,
             uneven_logit.py,
             scobit.py,
             clog_log.py,
...
from . import constrained_logit
# from . import constrained_logit_endo
...
model_type_to_class = {"MNL": mnl.MNL,
                       "CMNL": constrained_logit.CMNL,
                    #    "CMNL_endo": constrained_logit_endo.CMNL_endo,
...
**********CMNL*****************
    constraining_vars : list, or None, optional.
        ...
        present in the values of `names.values()` and they're associated
        variables should only be index variables (i.e. part of the design
        matrix). If `model_type == "CMNL"`, then `constraining_vars` 
        must be passed. Default == None.    
